...
from textlayout._legacy.backends import get_backend, list_backends as list_backend_registry
from textlayout._legacy.adapters import (
...
from textlayout._legacy.analytical import write_analytical_verification
from textlayout._legacy.automatic_mesh import generate_solver_inputs_from_graph
from textlayout._legacy.cad_export import write_cad_artifacts
from textlayout._legacy.cryostat import analyze_cryogenic_chain
from textlayout._legacy.design import plan_ljpa_design
from textlayout._legacy.drc import parse_drc_report, run_external_klayout_drc, run_python_process_drc
from textlayout._legacy.extraction import (
    labels_from_gds,
...
from textlayout._legacy.em_solvers import list_em_solvers as list_em_solver_metadata
from textlayout._legacy.em_solvers import recommend_em_solver as recommend_em_solver_for_sidecar
from textlayout._legacy.open_solver_manager import open_eigenmode as run_open_eigenmode
from textlayout._legacy.open_solver_manager import route as route_open_solver_plan
from textlayout._legacy.open_q3d import OpenQ3D, tune_idc_capacitance as run_idc_tuning
from textlayout._legacy.feasibility_gate import check_design_feasibility as run_design_feasibility
from textlayout._legacy.physics_templates import (
...
from textlayout._legacy.review import review_committee
from textlayout._legacy.ai_scientist import assess_design, write_review_report
from textlayout._legacy.layout_understanding import summarize_layout as summarize_layout_circuit
from textlayout._legacy.layout_quality import (
    DEFAULT_MODE as DEFAULT_LAYOUT_QUALITY_MODE,
    FABRICATION_REAL_PCELLS,
    QUARANTINED_TOY_PCELLS,
    gate_generation,
)
from textlayout._legacy.open_benchmarks import run_open_benchmarks as run_open_benchmark_suite
from textlayout._legacy.solver_agreement import cross_validate
from textlayout._legacy.signoff import evaluate_signoff
from textlayout._legacy.epr import write_epr_analysis
from textlayout._legacy.experiment_database import record_experiment
from textlayout._legacy.fitting import measurement_from_fit, write_measurement_fit
from textlayout._legacy.inverse_design import inverse_design_jpa
from textlayout._legacy.integrations import list_research_integrations as discover_research_integrations
from textlayout._legacy.improvements import (
    call_improvement,
...
from textlayout._legacy.meshing import write_stack_mesh
from textlayout._legacy.measurement_comparison import compare_measurement_to_simulation
from textlayout._legacy.optimization import optimize_ljpa_parameters
from textlayout._legacy.package_model import write_package_model
from textlayout._legacy.palace_bridge import write_palace_project
from textlayout._legacy.parasitics import export_fastcap as run_fastcap_extraction
from textlayout._legacy.parasitics import export_fasthenry as run_fasthenry_extraction
from textlayout._legacy.plots import write_simulation_plot
from textlayout._legacy.pcells import (
...
from textlayout._legacy.preview import write_stack_preview
from textlayout._legacy.process import DEFAULT_PROCESS
from textlayout._legacy.rendering import (
...
from textlayout._legacy.pyaedt_bridge import em_geometry_correction, write_pyaedt_project_bundle
from textlayout._legacy.pyaedt_benchmarks import run_pyaedt_benchmark_suite
from textlayout._legacy.research import (
...
from textlayout._legacy.jtwpa import write_gaydamachenko_benchmark
from textlayout._legacy.measurement_recipes import RECIPES, write_measurement_recipe
from textlayout._legacy.next_improvements import (
    call_next_improvement,
    list_next_improvements as build_next_improvement_registry,
    validate_next_improvement_registry,
)
from textlayout._legacy.paper_benchmarks import run_paper_benchmark_suite
from textlayout._legacy.pdk import PDKDatabase
from textlayout._legacy.process_database import (
    ProcessDatabase,
    plan_process_aware_jpa as build_process_aware_jpa_plan,
)
from textlayout._legacy.report import write_scientific_report
from textlayout._legacy.reference_compare import golden_compare as run_golden_compare
from textlayout._legacy.rf import write_rf_network_artifacts
from textlayout._legacy.scientific import write_scientific_plot, write_sweep_artifacts
from textlayout._legacy.simulation import estimate_physical_performance, simulate_ideal_junction
from textlayout._legacy.superconductivity import write_superconducting_material
from textlayout._legacy.superconducting_eda_compiler import create_flux_tunable_jpa_for_axion_search
from textlayout._legacy.third_wave import (
    call_third_wave_improvement,
    list_third_wave_improvements as build_third_wave_registry,
    validate_third_wave_registry,
)
from textlayout._legacy.traveling_wave import write_traveling_wave_paper_benchmark
from textlayout._legacy.uncertainty import run_process_monte_carlo
from textlayout._legacy.validation import build_validation_report
from textlayout._legacy.verification import (
...
def run_design_workflow(
    ...
    """
    from textlayout._legacy.design_intent import synthesize_design_intent, write_design_intent
    ...
    import json as _json
    from textlayout._legacy.review.committee import review_committee as _review_committee
    sidecar_dict = {}
    try:
...
def record_quantum_device(
    ...
    """
    from textlayout._legacy.quantum_device_database import (
        DeviceRecord,
        FabricationRecord,
        GeometryRecord,
        ProvenanceRecord,
...
def query_quantum_devices(
    ...
    from textlayout._legacy.quantum_device_database import QuantumDeviceDatabase
...
def validate_layout_geometry(
    ...
    """
    from textlayout._legacy.layout_validator import validate_layout
...
def predict_device_performance(
    ...
    """
    from textlayout._legacy.device_prediction import DevicePredictor
...
def score_layout_quality(
    ...
    """
    from textlayout._legacy.quality_scorer import LayoutQualityScorer
...
def tokenize_layout(
    ...
    """
    from textlayout._legacy.gds_tokenizer import GDSTokenizer
