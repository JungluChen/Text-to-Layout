...
from textlayout._legacy.extraction import labels_from_gds
...
def component_sidecar(
    ...
    if any(token in pcell.lower() for token in ("jj", "junction", "squid", "jpa")):
        try:
            from textlayout._legacy.extraction import _junction_overlap_area_um2
...
def render_layout_screenshot(
    ...
    *,
    ...
    from textlayout._legacy.pcells.layer_stack import (
        ANNOTATION_COLOR,
        SUBSTRATE_COLOR,
        annotation_font,
        draw_layer_legend,
