...
Usage::
    ...
    from textlayout._legacy.feedback import select_best_candidate, score_candidate
    from textlayout._legacy.supercad import parse_supercad
...
from textlayout._legacy.supercad import SuperCADSequence, compile_supercad
...
def score_candidate(
    ...
    if touchstone and Path(touchstone).is_file():
        solver_score += 0.5
        try:
            from textlayout._legacy.rf_validation import validate_touchstone
