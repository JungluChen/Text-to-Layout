...
_COMPANION_MODULES = {
    "FastCap": "textlayout._legacy.parasitics:export_fastcap",
    "FastHenry": "textlayout._legacy.parasitics:export_fasthenry",
    "JosephsonCircuits.jl": "textlayout._legacy.adapters:run_josephsoncircuits",
    "scqubits": "textlayout._legacy.research:write_hamiltonian_model",
}
