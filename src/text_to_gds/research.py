...
from text_to_gds.integrations import list_research_integrations
    ...
    *,
    ...
    bridge = {
        ...
        "architecture_mapping": [
            {"text_to_gds": "PCell", "quantum_metal": "QComponent"},
            {"text_to_gds": "GDS layer polygons", "quantum_metal": "qgeometry tables"},
            {"text_to_gds": "export_* tools", "quantum_metal": "renderers"},
            {"text_to_gds": "run_simulation", "quantum_metal": "analyses/simulations"},
        ],
