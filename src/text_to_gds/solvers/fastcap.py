...
def _build_fastcap_lst(
    *,
    ...
    return textwrap.dedent(f"""\
        * FastCap input ??{device_type} (w={w}繕m, s={s}繕m, l={length}繕m, t={t:.3f}繕m)
        * Generated by text-to-gds FastCap solver
        * Units: 繕m; capacitance output in pF
        *
        ...
        * Center conductor (conductor 1)
        Q center 1.0
          ...
          {w:.3f} {length:.3f} {h:.3f}    {0.0:.3f} {length:.3f} {h:.3f}
          {0.0:.3f} {0.0:.3f} {h+t:.3f}  {w:.3f} {0.0:.3f} {h+t:.3f}
          {w:.3f} {length:.3f} {h+t:.3f}  {0.0:.3f} {length:.3f} {h+t:.3f}
        *
        * Ground plane left (conductor 2)
        Q ground_l 0.0
          {-(s+w/2):.3f} {0.0:.3f} {h:.3f}    {-s:.3f} {0.0:.3f} {h:.3f}
          {-s:.3f} {length:.3f} {h:.3f}    {-(s+w/2):.3f} {length:.3f} {h:.3f}
        *
        * Ground plane right (conductor 3)
        Q ground_r 0.0
          {w+s:.3f} {0.0:.3f} {h:.3f}    {w+s+w/2:.3f} {0.0:.3f} {h:.3f}
          {w+s+w/2:.3f} {length:.3f} {h:.3f}  {w+s:.3f} {length:.3f} {h:.3f}
        """)
