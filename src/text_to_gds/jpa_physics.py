...
def solve_jpa_model(
    *,
    ...
    text_to_gds.backends.JosephsonCircuitsBackend or text_to_gds.josephsoncircuits_adapter.
    Analytical Kerr equations remain available under text_to_gds.theory as sanity checks,
