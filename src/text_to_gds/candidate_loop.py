...
def _step_compile(
    ...
    from text_to_gds.supercad import parse_supercad, compile_supercad
...
def _step_drc(candidate: CandidateResult) -> None:
    ...
    if not gds.is_file() or gds.stat().st_size == 0:
        ...
        return
    try:
        from text_to_gds.drc import run_python_process_drc
...
def generate_cpw_frequency_sweep(
    ...
    """
    from text_to_gds.physics_compiler import solve_cpw_resonator
