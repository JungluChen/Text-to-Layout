...
REQUIRED_ROOT_FILES = [
    ...
    "src/textlayout/backend/app.py",
    "scripts/generate_benchmarks.py",
    "simulation/sonnet_workflow.md",
    ...
    "skills/layout-research/SKILL.md",
    "skills/gdsfactory-layout/SKILL.md",
    "skills/layout-verification/SKILL.md",
    "skills/layout-simulation-evidence/SKILL.md",
