...
Generated: 2026-07-05T14:14:29+00:00 — by `scripts/generate_project_status.py`. Do not hand-edit; this file is a rendering of `out/evidence/project_status.json`.
...
- Total examples: 6
- Solver-backed (`PHYSICS_VERIFIED`/`SIMULATION_EXECUTED`): 01_idc_0p6pf, 03_idc_cpw_test_structure, 04_spiral_inductor_3nh
- Skipped (`SKIPPED_SOLVER_ABSENT`): 02_cpw_50ohm, 05_quarter_wave_resonator_6ghz
- Analytical only: 06_research_test_chip

## Tests

- **407 passed, 18 failed, 0 skipped** (source: pytest tests/textlayout_suite)
