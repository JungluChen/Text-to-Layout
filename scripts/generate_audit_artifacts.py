    ...
    capabilities = [
        ...
        capability_result(
            ...
            [
                ...
                Gate("positive and negative DRC fixtures exist", "REAL_FIXTURE_TESTED", path_exists("tests/fixtures/klayout_drc/expectations.json"), ("tests/fixtures/klayout_drc/expectations.json",)),
                Gate(
                    "containerized .lyrdb DRC fixtures validated",
                    "INTEGRATION_TEST_PASSED",
                    path_exists("out/audit/klayout_containerized_drc.json"),
                    ("out/audit/klayout_containerized_drc.json",),
                ),
            ],
            commit,
        ),
        ...
        capability_result(
            ...
            [
                ...
                Gate("partial LVS tests exist", "UNIT_TESTED", path_exists("tests/textlayout_suite/test_partial_lvs.py"), ("tests/textlayout_suite/test_partial_lvs.py",)),
                Gate("positive and negative partial LVS fixtures exist", "REAL_FIXTURE_TESTED", path_exists("tests/fixtures/klayout_lvs/expectations.json"), ("tests/fixtures/klayout_lvs/expectations.json",)),
                Gate(
                    "native KLayout extraction evidence exists",
                    "INTEGRATION_TEST_PASSED",
                    path_exists("out/audit/klayout_partial_electrical_lvs.json"),
                    ("out/audit/klayout_partial_electrical_lvs.json",),
                ),
            ],
            commit,
        ),
