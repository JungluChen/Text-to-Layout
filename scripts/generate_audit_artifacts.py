    ...
    capabilities = [
        ...
        capability_result(
            ...
            [
                ...
                Gate("positive and negative DRC fixtures validated", "INTEGRATION_TEST_PASSED", path_exists("out/audit/klayout_drc_fixtures.json"), ("out/audit/klayout_drc_fixtures.json",)),
            ],
            commit,
        ),
        capability_result(
