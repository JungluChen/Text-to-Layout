...
5. `POST /layout/generate` or `/layout/benchmark`.
6. Read the final verification, evidence, limitations, and simulation status. Do not describe an analytical value as simulated.
