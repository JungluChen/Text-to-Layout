...
| Check | Result |
| --- | --- |
| Validated descendant | `e6a224cf5ed2471f145e7a4eb3a78b776a7ef34c` (starting milestone commit `57c35e6b8900a777706d602849064280ef1637b4`) |
| `uv sync --all-extras` | OK (219 packages) |
| `uv run pytest -q` | **1698 passed, 0 failed, 2 skipped** |
| JUnit vs `PROJECT_STATUS.md` | matched after regenerating the status from the fresh JUnit report |
...
- Palace 0.17.0 pinned at `12d8069afb5aa9e169a17e303d735e120968e9f2`;
  solver state was `DOWNLOADED`, not installed, at baseline time
