...
| scqubits | **Experimental boundary.** The product adapter serializes a Hamiltonian handoff but deliberately returns failed/skipped until a component-specific model builder and cutoff-convergence tests exist. It is not an executed capability. | <https://github.com/scqubits/scqubits> |
